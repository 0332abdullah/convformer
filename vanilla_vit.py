...
for param in params:
    ...
    path = f'/content/vit_results/{param["block_type"]}_{param["depth"]}_{param["patch_size"]}.csv'
    df.to_csv(f'./vit_results/{param["block_type"]}_{param["depth"]}_{param["patch_size"]}.csv', index = False)
